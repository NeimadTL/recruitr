...
RSpec.describe Hr::PositionsController, type: :controller do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      xit "updates the requested position" do
        position = Position.create! valid_attributes
      ...
      xit "redirects to the position" do
        position = Position.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    xit "destroys the requested position" do
      position = Position.create! valid_attributes
      expect {
    ...
    xit "redirects to the positions list" do
      position = Position.create! valid_attributes
      delete :destroy, params: {id: position.to_param}, session: valid_session
